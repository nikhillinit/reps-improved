...
const ROUTER_STEM_DATA: Array<Omit<RouterStem, "semanticQa">> = [
  {
    id: "rs1",
    stem: "A factory orders raw materials at $50/order. Annual demand is 4,000 units. Holding cost is $2/unit/year. How many units should they order at a time?",
    correctId: "eoq",
  },
  {
    id: "rs2",
    stem: "A retailer wants to ensure a 95% service level. Daily demand has mean 80 and std dev 12. Lead time is 9 days. How much safety stock is needed?",
    correctId: "safety_stock",
  },
  {
    id: "rs3",
    stem: "A fashion retailer buys winter coats once per season. Cost is $60, selling price $120, salvage $20. Demand is normally distributed. What is the optimal order quantity approach?",
    correctId: "newsvendor",
  },
  {
    id: "rs4",
    stem: "A company is considering consolidating its three regional warehouses into one central facility. Each warehouse faces independent demand with σ=200 units. What is the benefit?",
    correctId: "risk_pooling",
  },
  {
    id: "rs5",
    stem: "A product has USL=100, LSL=80, process mean=92, σ=3. Is the process capable?",
    correctId: "spc",
  },
  {
    id: "rs6",
    stem: "A tech company wants to test whether a new checkout button increases conversion. They need to detect a 2% absolute lift. How do they determine sample size?",
    correctId: "experimentation",
  },
  {
    id: "rs7",
    stem: "A distributor replenishes stock every time inventory hits a certain level. Demand is variable with known mean and variance. Lead time is fixed. What determines the trigger level?",
    correctId: "safety_stock",
  },
  {
    id: "rs8",
    stem: "A bakery makes croissants each morning. Unsold croissants are discarded at end of day. Demand varies. How should they decide how many to bake?",
    correctId: "newsvendor",
  },
  {
    id: "rs9",
    stem: "A manufacturer wants to minimize the sum of ordering costs and inventory holding costs. Demand is constant and known. What model applies?",
    correctId: "eoq",
  },
  {
    id: "rs10",
    stem: "A control chart shows a process with all points within 3-sigma limits but trending upward. Is the process in control?",
    correctId: "spc",
  },
  {
    id: "rs11",
    stem: "A company runs two parallel promotions on its website to see which drives more signups. They track signups per visitor. What analysis framework applies?",
    correctId: "experimentation",
  },
  {
    id: "rs12",
    stem: "An e-commerce company has 4 regional fulfillment centers. They are considering whether pooling inventory would reduce their safety stock costs.",
    correctId: "risk_pooling",
  },
];
